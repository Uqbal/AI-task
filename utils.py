...
class Search(object):
    ...
    def check_new_state(self, cur_state: State, cur_cost: int, new_state: State, move_cost: int) -> Tuple(bool, int):
        """
        this function checks if the new_state is goal_state and process it accordingly
        """

        new_cost = 'x_x'
        self.came_from[new_state.board] = '+_+'
        self.visited[new_state.board] = '=_='
        """
        TODO 1:
